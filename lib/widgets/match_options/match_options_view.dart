    ...
    return BlocBuilder<MatchCubit, MatchState>(
      builder: (context, state) => state.when(
        ...
        success: (match) => Scaffold(
          appBar: AppBar(
            title: Text(S.of(context).MatchOptionsView_Title(match.name), overflow: TextOverflow.ellipsis),
          ),
          body: SettingsList(
              ...
              SettingsSection(
                ...
                tiles: [
                  SettingsTile(
                    ...
                    onPressed: (context) async => await _openMatchNamePopup(context, match.name),
                  )
                ],
              ),
              SettingsSection(
