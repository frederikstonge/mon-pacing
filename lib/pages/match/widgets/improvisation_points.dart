      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            title: Text(S.of(context).points, style: const TextStyle(fontWeight: FontWeight.bold)),
          ),
