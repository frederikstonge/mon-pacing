      ...
      body: BlocBuilder<MatchCubit, MatchState>(
        builder: (context, state) {
          return switch (state.status) {
            ...
            MatchStatus.error => Center(child: Text(state.error ?? '')),
            MatchStatus.success => Builder(
                builder: (context) {
                  final match = state.match!;
                  final selectedImprovisationIndex = state.selectedImprovisationIndex;
                  final selectedDurationIndex = state.selectedDurationIndex;
