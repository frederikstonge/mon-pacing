...
int serializePointModel(IsarWriter writer, PointModel object) {
  ...
  IsarCore.writeLong(writer, 5, object.matchId ?? -9223372036854775808);
  IsarCore.writeLong(
      writer,
      6,
...
extension PointModelQueryFilter
  ...
  QueryBuilder<PointModel, PointModel, QAfterFilterCondition> matchIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PointModel, PointModel, QAfterFilterCondition> matchIdEqualTo(
    int? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<PointModel, PointModel, QAfterFilterCondition> matchIdLessThan(
    int? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<PointModel, PointModel, QAfterFilterCondition> matchIdBetween(
    int? lower,
    int? upper,
  ) {
    return QueryBuilder.apply(this, (query) {
