...
class TeamModelMapper extends ClassMapperBase<TeamModel> {
  ...
  static const Field<TeamModel, DateTime> _f$createdDate = Field('createdDate', _$createdDate);
  static DateTime? _$modifiedDate(TeamModel v) => v.modifiedDate;
  static const Field<TeamModel, DateTime> _f$modifiedDate = Field('modifiedDate', _$modifiedDate);
  ...
  static const Field<TeamModel, List<PerformerModel>> _f$performers = Field(
    'performers',
    _$performers,
    opt: true,
    def: const [],
  ...
  static const Field<TeamModel, List<String>> _f$tags = Field('tags', _$tags, opt: true, def: const []);
  static String? _$integrationEntityId(TeamModel v) => v.integrationEntityId;
  static const Field<TeamModel, String> _f$integrationEntityId = Field(
    'integrationEntityId',
    _$integrationEntityId,
    opt: true,
  );
  static String? _$integrationAdditionalData(TeamModel v) => v.integrationAdditionalData;
...
mixin TeamModelMappable {
  String toJson() {
    return TeamModelMapper.ensureInitialized().encodeJson<TeamModel>(this as TeamModel);
  }

  Map<String, dynamic> toMap() {
    return TeamModelMapper.ensureInitialized().encodeMap<TeamModel>(this as TeamModel);
  }
  ...
  @override
  String toString() {
    return TeamModelMapper.ensureInitialized().stringifyValue(this as TeamModel);
  }

  @override
  bool operator ==(Object other) {
    return TeamModelMapper.ensureInitialized().equalsValue(this as TeamModel, other);
  }
...
extension TeamModelValueCopy<$R, $Out> on ObjectCopyWith<$R, TeamModel, $Out> {
  TeamModelCopyWith<$R, TeamModel, $Out> get $asTeamModel => $base.as((v, t, t2) => _TeamModelCopyWithImpl(v, t, t2));
}

abstract class TeamModelCopyWith<$R, $In extends TeamModel, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, PerformerModel, PerformerModelCopyWith<$R, PerformerModel, PerformerModel>> get performers;
...
class _TeamModelCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, TeamModel, $Out>
    implements TeamModelCopyWith<$R, TeamModel, $Out> {
  _TeamModelCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<TeamModel> $mapper = TeamModelMapper.ensureInitialized();
  @override
  ListCopyWith<$R, PerformerModel, PerformerModelCopyWith<$R, PerformerModel, PerformerModel>> get performers =>
  ...
  @override
  TeamModelCopyWith<$R2, TeamModel, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
