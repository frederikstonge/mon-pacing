...
class TeamModelMapper extends ClassMapperBase<TeamModel> {
  ...
  static const Field<TeamModel, DateTime> _f$createdDate = Field(
    'createdDate',
    _$createdDate,
  );
  static DateTime? _$modifiedDate(TeamModel v) => v.modifiedDate;
  static const Field<TeamModel, DateTime> _f$modifiedDate = Field(
    'modifiedDate',
    _$modifiedDate,
  );
  ...
  static const Field<TeamModel, List<TagModel>> _f$tags = Field(
    'tags',
    _$tags,
    opt: true,
    def: const [],
...
mixin TeamModelMappable {
  String toJson() {
    return TeamModelMapper.ensureInitialized().encodeJson<TeamModel>(
      this as TeamModel,
    );
  }

  Map<String, dynamic> toMap() {
    return TeamModelMapper.ensureInitialized().encodeMap<TeamModel>(
      this as TeamModel,
    );
  }
  ...
  @override
  String toString() {
    return TeamModelMapper.ensureInitialized().stringifyValue(
      this as TeamModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return TeamModelMapper.ensureInitialized().equalsValue(
      this as TeamModel,
      other,
    );
  }
