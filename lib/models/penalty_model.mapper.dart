...
class PenaltyModelMapper extends ClassMapperBase<PenaltyModel> {
  ...
  static const Field<PenaltyModel, int> _f$performerId = Field(
    'performerId',
    _$performerId,
  );
  ...
  static const Field<PenaltyModel, int> _f$improvisationId = Field(
    'improvisationId',
    _$improvisationId,
  );
  static String? _$integrationEntityId(PenaltyModel v) => v.integrationEntityId;
  static const Field<PenaltyModel, String> _f$integrationEntityId = Field(
    'integrationEntityId',
...
mixin PenaltyModelMappable {
  String toJson() {
    return PenaltyModelMapper.ensureInitialized().encodeJson<PenaltyModel>(
      this as PenaltyModel,
    );
  }

  Map<String, dynamic> toMap() {
    return PenaltyModelMapper.ensureInitialized().encodeMap<PenaltyModel>(
      this as PenaltyModel,
    );
  }
  ...
  @override
  String toString() {
    return PenaltyModelMapper.ensureInitialized().stringifyValue(
      this as PenaltyModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return PenaltyModelMapper.ensureInitialized().equalsValue(
      this as PenaltyModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PenaltyModelMapper.ensureInitialized().hashValue(
      this as PenaltyModel,
    );
  }
}
