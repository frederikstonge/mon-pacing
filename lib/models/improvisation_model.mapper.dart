...
class ImprovisationModelMapper extends ClassMapperBase<ImprovisationModel> {
  ...
  static const Field<ImprovisationModel, ImprovisationType> _f$type = Field(
    'type',
    _$type,
  );
  static String _$category(ImprovisationModel v) => v.category;
  static const Field<ImprovisationModel, String> _f$category = Field(
    'category',
    _$category,
  );
  static String _$theme(ImprovisationModel v) => v.theme;
  static const Field<ImprovisationModel, String> _f$theme = Field(
    'theme',
    _$theme,
  );
  ...
  static const Field<ImprovisationModel, String> _f$performers = Field(
    'performers',
    _$performers,
  );
  static String _$notes(ImprovisationModel v) => v.notes;
  static const Field<ImprovisationModel, String> _f$notes = Field(
    'notes',
    _$notes,
  );
  static DateTime? _$createdDate(ImprovisationModel v) => v.createdDate;
  static const Field<ImprovisationModel, DateTime> _f$createdDate = Field(
    'createdDate',
    _$createdDate,
    opt: true,
  );
  static DateTime? _$modifiedDate(ImprovisationModel v) => v.modifiedDate;
  static const Field<ImprovisationModel, DateTime> _f$modifiedDate = Field(
    'modifiedDate',
    _$modifiedDate,
    opt: true,
  );
  ...
  static const Field<ImprovisationModel, int> _f$timeBufferInSeconds = Field(
    'timeBufferInSeconds',
    _$timeBufferInSeconds,
    opt: true,
    def: 30,
  );
  static int _$huddleTimerInSeconds(ImprovisationModel v) =>
      v.huddleTimerInSeconds;
  static const Field<ImprovisationModel, int> _f$huddleTimerInSeconds = Field(
    'huddleTimerInSeconds',
    _$huddleTimerInSeconds,
    opt: true,
    def: 30,
  );
  static String? _$integrationEntityId(ImprovisationModel v) =>
      v.integrationEntityId;
  static const Field<ImprovisationModel, String> _f$integrationEntityId = Field(
    'integrationEntityId',
...
mixin ImprovisationModelMappable {
  ...
  ImprovisationModelCopyWith<
    ImprovisationModel,
    ImprovisationModel,
    ImprovisationModel
  >
  get copyWith =>
      _ImprovisationModelCopyWithImpl<ImprovisationModel, ImprovisationModel>(
        this as ImprovisationModel,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return ImprovisationModelMapper.ensureInitialized().stringifyValue(
      this as ImprovisationModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return ImprovisationModelMapper.ensureInitialized().equalsValue(
      this as ImprovisationModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ImprovisationModelMapper.ensureInitialized().hashValue(
      this as ImprovisationModel,
    );
  }
}
...
abstract class ImprovisationModelCopyWith<
  $R,
  $In extends ImprovisationModel,
  $Out
>
...
class _ImprovisationModelCopyWithImpl<$R, $Out>
  ...
  ImprovisationModel $make(CopyWithData data) => ImprovisationModel(
    ...
    durationsInSeconds: data.get(
      #durationsInSeconds,
      or: $value.durationsInSeconds,
    ),
    ...
    timeBufferInSeconds: data.get(
      #timeBufferInSeconds,
      or: $value.timeBufferInSeconds,
    ),
    huddleTimerInSeconds: data.get(
      #huddleTimerInSeconds,
      or: $value.huddleTimerInSeconds,
    ),
