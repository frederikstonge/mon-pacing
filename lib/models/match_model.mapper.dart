...
class MatchModelMapper extends ClassMapperBase<MatchModel> {
  ...
  static const Field<MatchModel, DateTime> _f$createdDate = Field(
    'createdDate',
    _$createdDate,
  );
  static DateTime? _$modifiedDate(MatchModel v) => v.modifiedDate;
  static const Field<MatchModel, DateTime> _f$modifiedDate = Field(
    'modifiedDate',
    _$modifiedDate,
  );
  static List<TeamModel> _$teams(MatchModel v) => v.teams;
  static const Field<MatchModel, List<TeamModel>> _f$teams = Field(
    'teams',
    _$teams,
  );
  ...
  static const Field<MatchModel, List<PenaltyModel>> _f$penalties = Field(
    'penalties',
    _$penalties,
  );
  static List<PointModel> _$points(MatchModel v) => v.points;
  static const Field<MatchModel, List<PointModel>> _f$points = Field(
    'points',
    _$points,
  );
  static List<StarModel> _$stars(MatchModel v) => v.stars;
  static const Field<MatchModel, List<StarModel>> _f$stars = Field(
    'stars',
    _$stars,
    opt: true,
    def: const [],
  ...
  static const Field<MatchModel, bool> _f$enableStatistics = Field(
    'enableStatistics',
    _$enableStatistics,
    opt: true,
    def: true,
  ...
  static const Field<MatchModel, PenaltiesImpactType> _f$penaltiesImpactType =
      Field(
        'penaltiesImpactType',
        _$penaltiesImpactType,
        opt: true,
        def: PenaltiesImpactType.addPoints,
      );
  ...
  static const Field<MatchModel, int> _f$penaltiesRequiredToImpactPoints =
      Field(
        ...
        _$penaltiesRequiredToImpactPoints,
        opt: true,
        def: 3,
      );
  ...
  static const Field<MatchModel, int> _f$penaltiesRequiredToExpel = Field(
    ...
    _$penaltiesRequiredToExpel,
    opt: true,
    def: 3,
  );
  static List<TagModel> _$tags(MatchModel v) => v.tags;
  static const Field<MatchModel, List<TagModel>> _f$tags = Field(
    'tags',
    _$tags,
    opt: true,
    def: const [],
  ...
  static const Field<MatchModel, String> _f$integrationId = Field(
    'integrationId',
    _$integrationId,
    opt: true,
  );
  static String? _$integrationEntityId(MatchModel v) => v.integrationEntityId;
  static const Field<MatchModel, String> _f$integrationEntityId = Field(
    'integrationEntityId',
  ...
  static const Field<MatchModel, int> _f$maximumPointsPerImprovisation = Field(
    ...
    _$maximumPointsPerImprovisation,
    opt: true,
  );
  ...
  static const Field<MatchModel, int> _f$minNumberOfImprovisations = Field(
    'minNumberOfImprovisations',
    _$minNumberOfImprovisations,
    opt: true,
  );
  ...
  static const Field<MatchModel, int> _f$maxNumberOfImprovisations = Field(
    'maxNumberOfImprovisations',
    _$maxNumberOfImprovisations,
    opt: true,
  );
  static List<String>? _$penaltyTypes(MatchModel v) => v.penaltyTypes;
  static const Field<MatchModel, List<String>> _f$penaltyTypes = Field(
    'penaltyTypes',
    _$penaltyTypes,
    opt: true,
  );
  ...
  static MatchModel _instantiate(DecodingData data) {
    return MatchModel(
      ...
      penaltiesRequiredToImpactPoints: data.dec(
        _f$penaltiesRequiredToImpactPoints,
      ),
      ...
      maximumPointsPerImprovisation: data.dec(_f$maximumPointsPerImprovisation),
...
mixin MatchModelMappable {
  String toJson() {
    return MatchModelMapper.ensureInitialized().encodeJson<MatchModel>(
      this as MatchModel,
    );
  }

  Map<String, dynamic> toMap() {
    return MatchModelMapper.ensureInitialized().encodeMap<MatchModel>(
      this as MatchModel,
    );
  }
  ...
  @override
  String toString() {
    return MatchModelMapper.ensureInitialized().stringifyValue(
      this as MatchModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return MatchModelMapper.ensureInitialized().equalsValue(
      this as MatchModel,
      other,
    );
  }
...
class _MatchModelCopyWithImpl<$R, $Out>
  ...
  MatchModel $make(CopyWithData data) => MatchModel(
    ...
    enableStatistics: data.get(#enableStatistics, or: $value.enableStatistics),
    enablePenaltiesImpactPoints: data.get(
      #enablePenaltiesImpactPoints,
      or: $value.enablePenaltiesImpactPoints,
    ),
    penaltiesImpactType: data.get(
      #penaltiesImpactType,
      or: $value.penaltiesImpactType,
    ),
    penaltiesRequiredToImpactPoints: data.get(
      #penaltiesRequiredToImpactPoints,
      or: $value.penaltiesRequiredToImpactPoints,
    ),
    enableMatchExpulsion: data.get(
      #enableMatchExpulsion,
      or: $value.enableMatchExpulsion,
    ),
    penaltiesRequiredToExpel: data.get(
      #penaltiesRequiredToExpel,
    ...
    maximumPointsPerImprovisation: data.get(
      #maximumPointsPerImprovisation,
      or: $value.maximumPointsPerImprovisation,
    ),
    minNumberOfImprovisations: data.get(
      #minNumberOfImprovisations,
      or: $value.minNumberOfImprovisations,
    ),
    maxNumberOfImprovisations: data.get(
      #maxNumberOfImprovisations,
