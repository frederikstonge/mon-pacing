...
mixin PerformerModelMappable {
  String toJson() {
    return PerformerModelMapper.ensureInitialized().encodeJson<PerformerModel>(
      this as PerformerModel,
    );
  }

  Map<String, dynamic> toMap() {
    return PerformerModelMapper.ensureInitialized().encodeMap<PerformerModel>(
      this as PerformerModel,
    );
  }

  PerformerModelCopyWith<PerformerModel, PerformerModel, PerformerModel>
  get copyWith => _PerformerModelCopyWithImpl<PerformerModel, PerformerModel>(
    this as PerformerModel,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return PerformerModelMapper.ensureInitialized().stringifyValue(
      this as PerformerModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return PerformerModelMapper.ensureInitialized().equalsValue(
      this as PerformerModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PerformerModelMapper.ensureInitialized().hashValue(
      this as PerformerModel,
    );
  }
}
