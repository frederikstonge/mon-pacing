...
class TaskMessageMapper extends ClassMapperBase<TaskMessage> {
  ...
  static const Field<TaskMessage, int> _f$durationInSeconds = Field(
    'durationInSeconds',
    _$durationInSeconds,
  );
  static TimerStatus _$status(TaskMessage v) => v.status;
  static const Field<TaskMessage, TimerStatus> _f$status = Field(
    'status',
    _$status,
  );
  static bool _$hapticFeedback(TaskMessage v) => v.hapticFeedback;
  static const Field<TaskMessage, bool> _f$hapticFeedback = Field(
    'hapticFeedback',
    _$hapticFeedback,
  );
  static String _$notificationTitle(TaskMessage v) => v.notificationTitle;
  static const Field<TaskMessage, String> _f$notificationTitle = Field(
    'notificationTitle',
    _$notificationTitle,
  );
...
mixin TaskMessageMappable {
  String toJson() {
    return TaskMessageMapper.ensureInitialized().encodeJson<TaskMessage>(
      this as TaskMessage,
    );
  }

  Map<String, dynamic> toMap() {
    return TaskMessageMapper.ensureInitialized().encodeMap<TaskMessage>(
      this as TaskMessage,
    );
  }
  ...
  @override
  String toString() {
    return TaskMessageMapper.ensureInitialized().stringifyValue(
      this as TaskMessage,
    );
  }
  ...
  bool operator ==(Object other) {
    return TaskMessageMapper.ensureInitialized().equalsValue(
      this as TaskMessage,
      other,
    );
  }
