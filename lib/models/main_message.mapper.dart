...
class MainMessageMapper extends ClassMapperBase<MainMessage> {
  ...
  static const Field<MainMessage, int> _f$remainingMilliseconds = Field(
    'remainingMilliseconds',
    _$remainingMilliseconds,
  );
  static TimerStatus? _$requestedStatus(MainMessage v) => v.requestedStatus;
  static const Field<MainMessage, TimerStatus> _f$requestedStatus = Field(
    'requestedStatus',
    _$requestedStatus,
    opt: true,
  );
...
mixin MainMessageMappable {
  String toJson() {
    return MainMessageMapper.ensureInitialized().encodeJson<MainMessage>(
      this as MainMessage,
    );
  }

  Map<String, dynamic> toMap() {
    return MainMessageMapper.ensureInitialized().encodeMap<MainMessage>(
      this as MainMessage,
    );
  }
  ...
  @override
  String toString() {
    return MainMessageMapper.ensureInitialized().stringifyValue(
      this as MainMessage,
    );
  }
  ...
  bool operator ==(Object other) {
    return MainMessageMapper.ensureInitialized().equalsValue(
      this as MainMessage,
      other,
    );
  }
