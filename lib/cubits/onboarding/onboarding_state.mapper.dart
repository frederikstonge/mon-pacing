...
class OnboardingStateMapper extends ClassMapperBase<OnboardingState> {
  ...
  static const Field<OnboardingState, bool> _f$onboardingFinished = Field(
    'onboardingFinished',
    _$onboardingFinished,
    opt: true,
    def: false,
  );
...
class _OnboardingStateCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({bool? onboardingFinished}) => $apply(
    FieldCopyWithData({
  ...
  OnboardingState $make(CopyWithData data) => OnboardingState(
    onboardingFinished: data.get(
      #onboardingFinished,
      or: $value.onboardingFinished,
    ),
  );
