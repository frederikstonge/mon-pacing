...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static const Field<SettingsState, String> _f$language = Field(
    'language',
    _$language,
  );
  static ThemeType _$theme(SettingsState v) => v.theme;
  static const Field<SettingsState, ThemeType> _f$theme = Field(
    'theme',
    _$theme,
  );
  static bool _$enableWakelock(SettingsState v) => v.enableWakelock;
  static const Field<SettingsState, bool> _f$enableWakelock = Field(
    'enableWakelock',
    _$enableWakelock,
    opt: true,
    def: true,
  ...
  static const Field<SettingsState, bool> _f$enableTimerHapticFeedback = Field(
    ...
    _$enableTimerHapticFeedback,
    opt: true,
    def: true,
  );
  static int _$defaultNumberOfTeams(SettingsState v) => v.defaultNumberOfTeams;
  static const Field<SettingsState, int> _f$defaultNumberOfTeams = Field(
  ...
  static const Field<SettingsState, int> _f$defaultPenaltiesRequiredToExpel =
      Field(
        ...
        _$defaultPenaltiesRequiredToExpel,
        opt: true,
        def: 3,
      );
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
      ...
      defaultImprovisationDurationInSeconds: data.dec(
        _f$defaultImprovisationDurationInSeconds,
      ),
      ...
      enableDefaultPenaltiesImpactPoints: data.dec(
        _f$enableDefaultPenaltiesImpactPoints,
      ),
      defaultPenaltiesImpactType: data.dec(_f$defaultPenaltiesImpactType),
      defaultPenaltiesRequiredToImpactPoints: data.dec(
        _f$defaultPenaltiesRequiredToImpactPoints,
      ),
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (enableDefaultPenaltiesImpactPoints != null)
        #enableDefaultPenaltiesImpactPoints: enableDefaultPenaltiesImpactPoints,
  ...
  SettingsState $make(CopyWithData data) => SettingsState(
    ...
    enableHapticFeedback: data.get(
      #enableHapticFeedback,
      or: $value.enableHapticFeedback,
    ),
    enableTimerHapticFeedback: data.get(
      #enableTimerHapticFeedback,
    ...
    defaultTimeBufferInSeconds: data.get(
      #defaultTimeBufferInSeconds,
      or: $value.defaultTimeBufferInSeconds,
    ),
    defaultHuddleTimerInSeconds: data.get(
      #defaultHuddleTimerInSeconds,
      or: $value.defaultHuddleTimerInSeconds,
    ),
    defaultEnableStatistics: data.get(
      #defaultEnableStatistics,
    ...
    defaultPenaltiesImpactType: data.get(
      #defaultPenaltiesImpactType,
    ...
    enableDefaultMatchExpulsion: data.get(
      #enableDefaultMatchExpulsion,
