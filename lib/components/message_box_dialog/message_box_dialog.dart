        ...
        builder:
            (BuildContext context) => Dialog(
              ...
              child: Padding(
                ...
                child: _MessageBoxContent(question: question, yesLabel: yesLabel, noLabel: noLabel),
              ),
            ),
      );
}
...
class _MessageBoxContent extends StatelessWidget {
  ...
  const _MessageBoxContent({required this.question, required this.yesLabel, required this.noLabel});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(question, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold)),
