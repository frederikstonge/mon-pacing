...
class TeamEntityMapper extends ClassMapperBase<TeamEntity> {
  ...
  static const Field<TeamEntity, DateTime> _f$createdDate = Field('createdDate', _$createdDate);
  static DateTime? _$modifiedDate(TeamEntity v) => v.modifiedDate;
  static const Field<TeamEntity, DateTime> _f$modifiedDate = Field('modifiedDate', _$modifiedDate);
  ...
  static const Field<TeamEntity, List<PerformerEntity>> _f$performers = Field(
    'performers',
    _$performers,
    opt: true,
    def: const [],
  ...
  static const Field<TeamEntity, List<String>> _f$tags = Field('tags', _$tags, opt: true, def: const []);
...
mixin TeamEntityMappable {
  String toJson() {
    return TeamEntityMapper.ensureInitialized().encodeJson<TeamEntity>(this as TeamEntity);
  }

  Map<String, dynamic> toMap() {
    return TeamEntityMapper.ensureInitialized().encodeMap<TeamEntity>(this as TeamEntity);
  }
  ...
  @override
  String toString() {
    return TeamEntityMapper.ensureInitialized().stringifyValue(this as TeamEntity);
  }

  @override
  bool operator ==(Object other) {
    return TeamEntityMapper.ensureInitialized().equalsValue(this as TeamEntity, other);
  }
...
extension TeamEntityValueCopy<$R, $Out> on ObjectCopyWith<$R, TeamEntity, $Out> {
  TeamEntityCopyWith<$R, TeamEntity, $Out> get $asTeamEntity =>
      $base.as((v, t, t2) => _TeamEntityCopyWithImpl(v, t, t2));
}

abstract class TeamEntityCopyWith<$R, $In extends TeamEntity, $Out> implements ClassCopyWith<$R, $In, $Out> {
...
class _TeamEntityCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, TeamEntity, $Out>
    implements TeamEntityCopyWith<$R, TeamEntity, $Out> {
  _TeamEntityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<TeamEntity> $mapper = TeamEntityMapper.ensureInitialized();
  @override
  ListCopyWith<$R, PerformerEntity, PerformerEntityCopyWith<$R, PerformerEntity, PerformerEntity>> get performers =>
  ...
  @override
  TeamEntityCopyWith<$R2, TeamEntity, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
