...
class MatchTeamEntityMapper extends ClassMapperBase<MatchTeamEntity> {
  ...
  static const Field<MatchTeamEntity, List<PerformerEntity>> _f$performers = Field(
    'performers',
    _$performers,
    opt: true,
    def: const [],
  );
  static String? _$integrationEntityId(MatchTeamEntity v) => v.integrationEntityId;
  static const Field<MatchTeamEntity, String> _f$integrationEntityId = Field(
    'integrationEntityId',
    _$integrationEntityId,
    opt: true,
  );
  static String? _$integrationAdditionalData(MatchTeamEntity v) => v.integrationAdditionalData;
  static const Field<MatchTeamEntity, String> _f$integrationAdditionalData = Field(
...
mixin MatchTeamEntityMappable {
  String toJson() {
    return MatchTeamEntityMapper.ensureInitialized().encodeJson<MatchTeamEntity>(this as MatchTeamEntity);
  }

  Map<String, dynamic> toMap() {
    return MatchTeamEntityMapper.ensureInitialized().encodeMap<MatchTeamEntity>(this as MatchTeamEntity);
  }

  MatchTeamEntityCopyWith<MatchTeamEntity, MatchTeamEntity, MatchTeamEntity> get copyWith =>
      _MatchTeamEntityCopyWithImpl(this as MatchTeamEntity, $identity, $identity);
  @override
  String toString() {
    return MatchTeamEntityMapper.ensureInitialized().stringifyValue(this as MatchTeamEntity);
  }

  @override
  bool operator ==(Object other) {
    return MatchTeamEntityMapper.ensureInitialized().equalsValue(this as MatchTeamEntity, other);
  }

  @override
  int get hashCode {
    return MatchTeamEntityMapper.ensureInitialized().hashValue(this as MatchTeamEntity);
  }
}

extension MatchTeamEntityValueCopy<$R, $Out> on ObjectCopyWith<$R, MatchTeamEntity, $Out> {
  MatchTeamEntityCopyWith<$R, MatchTeamEntity, $Out> get $asMatchTeamEntity =>
      $base.as((v, t, t2) => _MatchTeamEntityCopyWithImpl(v, t, t2));
}

abstract class MatchTeamEntityCopyWith<$R, $In extends MatchTeamEntity, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, PerformerEntity, PerformerEntityCopyWith<$R, PerformerEntity, PerformerEntity>> get performers;
  $R call({
    int? id,
    String? name,
    int? color,
  ...
  MatchTeamEntityCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _MatchTeamEntityCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, MatchTeamEntity, $Out>
    implements MatchTeamEntityCopyWith<$R, MatchTeamEntity, $Out> {
  _MatchTeamEntityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<MatchTeamEntity> $mapper = MatchTeamEntityMapper.ensureInitialized();
  @override
  ListCopyWith<$R, PerformerEntity, PerformerEntityCopyWith<$R, PerformerEntity, PerformerEntity>> get performers =>
      ListCopyWith($value.performers, (v, t) => v.copyWith.$chain(t), (v) => call(performers: v));
  @override
  $R call({
    int? id,
    String? name,
  ...
  @override
  MatchTeamEntityCopyWith<$R2, MatchTeamEntity, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
