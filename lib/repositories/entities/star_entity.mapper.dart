...
class StarEntityMapper extends ClassMapperBase<StarEntity> {
  ...
  static const Field<StarEntity, int> _f$performerId = Field('performerId', _$performerId);
  static int _$teamId(StarEntity v) => v.teamId;
  static const Field<StarEntity, int> _f$teamId = Field('teamId', _$teamId);

  @override
  final MappableFields<StarEntity> fields = const {#id: _f$id, #performerId: _f$performerId, #teamId: _f$teamId};

  static StarEntity _instantiate(DecodingData data) {
    return StarEntity(id: data.dec(_f$id), performerId: data.dec(_f$performerId), teamId: data.dec(_f$teamId));
  }
...
mixin StarEntityMappable {
  String toJson() {
    return StarEntityMapper.ensureInitialized().encodeJson<StarEntity>(this as StarEntity);
  }

  Map<String, dynamic> toMap() {
    return StarEntityMapper.ensureInitialized().encodeMap<StarEntity>(this as StarEntity);
  }
  ...
  @override
  String toString() {
    return StarEntityMapper.ensureInitialized().stringifyValue(this as StarEntity);
  }

  @override
  bool operator ==(Object other) {
    return StarEntityMapper.ensureInitialized().equalsValue(this as StarEntity, other);
  }
...
extension StarEntityValueCopy<$R, $Out> on ObjectCopyWith<$R, StarEntity, $Out> {
  StarEntityCopyWith<$R, StarEntity, $Out> get $asStarEntity =>
      $base.as((v, t, t2) => _StarEntityCopyWithImpl(v, t, t2));
}

abstract class StarEntityCopyWith<$R, $In extends StarEntity, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({int? id, int? performerId, int? teamId});
  StarEntityCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _StarEntityCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, StarEntity, $Out>
    implements StarEntityCopyWith<$R, StarEntity, $Out> {
  _StarEntityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<StarEntity> $mapper = StarEntityMapper.ensureInitialized();
  @override
  ...
  @override
  StarEntityCopyWith<$R2, StarEntity, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
