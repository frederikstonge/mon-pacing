...
class PerformerEntityMapper extends ClassMapperBase<PerformerEntity> {
  ...
  static String? _$integrationEntityId(PerformerEntity v) => v.integrationEntityId;
  static const Field<PerformerEntity, String> _f$integrationEntityId = Field(
    'integrationEntityId',
    _$integrationEntityId,
    opt: true,
  );
  static String? _$integrationAdditionalData(PerformerEntity v) => v.integrationAdditionalData;
  static const Field<PerformerEntity, String> _f$integrationAdditionalData = Field(
...
mixin PerformerEntityMappable {
  String toJson() {
    return PerformerEntityMapper.ensureInitialized().encodeJson<PerformerEntity>(this as PerformerEntity);
  }

  Map<String, dynamic> toMap() {
    return PerformerEntityMapper.ensureInitialized().encodeMap<PerformerEntity>(this as PerformerEntity);
  }

  PerformerEntityCopyWith<PerformerEntity, PerformerEntity, PerformerEntity> get copyWith =>
      _PerformerEntityCopyWithImpl(this as PerformerEntity, $identity, $identity);
  @override
  String toString() {
    return PerformerEntityMapper.ensureInitialized().stringifyValue(this as PerformerEntity);
  }

  @override
  bool operator ==(Object other) {
    return PerformerEntityMapper.ensureInitialized().equalsValue(this as PerformerEntity, other);
  }

  @override
  int get hashCode {
    return PerformerEntityMapper.ensureInitialized().hashValue(this as PerformerEntity);
  }
}

extension PerformerEntityValueCopy<$R, $Out> on ObjectCopyWith<$R, PerformerEntity, $Out> {
  PerformerEntityCopyWith<$R, PerformerEntity, $Out> get $asPerformerEntity =>
      $base.as((v, t, t2) => _PerformerEntityCopyWithImpl(v, t, t2));
}

abstract class PerformerEntityCopyWith<$R, $In extends PerformerEntity, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({int? id, String? name, String? integrationEntityId, String? integrationAdditionalData});
  PerformerEntityCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _PerformerEntityCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, PerformerEntity, $Out>
    implements PerformerEntityCopyWith<$R, PerformerEntity, $Out> {
  _PerformerEntityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<PerformerEntity> $mapper = PerformerEntityMapper.ensureInitialized();
  @override
  ...
  @override
  PerformerEntityCopyWith<$R2, PerformerEntity, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
