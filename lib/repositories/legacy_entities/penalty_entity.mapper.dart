...
class PenaltyEntityMapper extends ClassMapperBase<PenaltyEntity> {
  ...
  static const Field<PenaltyEntity, int> _f$performerId =
  ...
  static const Field<PenaltyEntity, int> _f$improvisationId =
...
mixin PenaltyEntityMappable {
  String toJson() {
    return PenaltyEntityMapper.ensureInitialized()
        .encodeJson<PenaltyEntity>(this as PenaltyEntity);
  }

  Map<String, dynamic> toMap() {
    return PenaltyEntityMapper.ensureInitialized()
        .encodeMap<PenaltyEntity>(this as PenaltyEntity);
  }

  PenaltyEntityCopyWith<PenaltyEntity, PenaltyEntity, PenaltyEntity>
      get copyWith => _PenaltyEntityCopyWithImpl(
          this as PenaltyEntity, $identity, $identity);
  @override
  String toString() {
    return PenaltyEntityMapper.ensureInitialized()
        .stringifyValue(this as PenaltyEntity);
  }

  @override
  bool operator ==(Object other) {
    return PenaltyEntityMapper.ensureInitialized()
        .equalsValue(this as PenaltyEntity, other);
  }

  @override
  int get hashCode {
    return PenaltyEntityMapper.ensureInitialized()
        .hashValue(this as PenaltyEntity);
  }
}

extension PenaltyEntityValueCopy<$R, $Out>
    on ObjectCopyWith<$R, PenaltyEntity, $Out> {
  PenaltyEntityCopyWith<$R, PenaltyEntity, $Out> get $asPenaltyEntity =>
      $base.as((v, t, t2) => _PenaltyEntityCopyWithImpl(v, t, t2));
}

abstract class PenaltyEntityCopyWith<$R, $In extends PenaltyEntity, $Out>
...
class _PenaltyEntityCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, PenaltyEntity, $Out>
    implements PenaltyEntityCopyWith<$R, PenaltyEntity, $Out> {
  _PenaltyEntityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<PenaltyEntity> $mapper =
  ...
  @override
  PenaltyEntityCopyWith<$R2, PenaltyEntity, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
