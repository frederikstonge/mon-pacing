...
class MatchOptionsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: BlocBuilder<MatchCubit, MatchModel>(
        builder: (context, state) => Text(S.of(context).MatchOptionsView_Title(state.name)),
      )),
          ...
          return SettingsList(
            sections: [
              SettingsSection(
                tiles: [
                  SettingsTile(
                    title: Text(S.of(context).MatchOptionsView_Name),
                    value: TextFormField(
                      onChanged: (value) {
              ...
              SettingsSection(
                title: ListTile(
                  title: Text(S.of(context).MatchOptionsView_Teams),
                        ...
                        onTap: () {
                          showDialog(
                            ...
                            builder: (dialogContext) {
                              return AlertDialog(
                                title: Text(S.of(context).MatchOptionsView_TeamColor),
